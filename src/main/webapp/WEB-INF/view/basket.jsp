...
<div class="container">
    <div class="my-sm-3">
        <div class="row justify-content-center">
                ...
                <c:forEach var="order" items="${orders}">
                    <tr>
                        ...
                        <td>
                            <c:forEach var="product" items="${products}">
                                <c:if test="${product.id == order.productId}">
                                    <p><c:out value="${product.price}"/> <fmt:message bundle="${info}" key="information.price"/></p>
                                </c:if>
                            </c:forEach>
                        </td>
                        <td>
            ...
            <button type="button" class="btn btn-primary"><fmt:message bundle="${loc}" key="language.arrange"/></button>
        </div>
    </div>
</div>
</body>
