    ...
    <div class="p-3 p-md-4 border rounded-3 my-sm-3">
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td width="300px"><h4 class="text-primary"><fmt:message bundle="${loc}" key="language.mobilePhone"/>:</h4></td>
            ...
            <tr>
                ...
                <td width="300px"><h4 class="text-primary"><fmt:message bundle="${loc}" key="language.emailAddress"/>:</h4></td>
